 ...
 * exportar do app produz. Reexportado aqui para `utils/characterRelationGraphSvg` continuar sendo um caminho
 * válido dentro do app - mesmo arranjo de `theme/palettes`.
 */
export * from '@keres/shared/graphs/characterRelationGraphSvg';
