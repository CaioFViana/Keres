...
const page: HelpPage = {
  id: 'favorites',
  title: 'Favorites',
  summary: 'Highlight what you need to find again quickly.',
  keywords: ['favorites', 'story'],
  blocks: [
    { type: 'heading', level: 2, text: 'What it is' },
    {
      type: 'paragraph',
      text: 'Favorites mark important stories and elements. In collaboration, the story defines whether the mark is global, individual, or public individual.',
    },
    { type: 'heading', level: 2, text: 'What it is for' },
    {
      type: 'example',
      title: 'Example',
      text: 'Use favorites to organize the narrative and check links before writing or revising.',
    },
