...
const page: HelpPage = {
  ...
  summary: 'Find paths for common difficulties.',
  keywords: ['solving problems', 'help'],
  blocks: [
    { type: 'heading', level: 2, text: 'What it is' },
    {
      type: 'paragraph',
      text: 'This page gathers symptoms, likely causes, and safe actions for connection, sessions, import, media, and stories.',
    },
    { type: 'heading', level: 2, text: 'What it is for' },
    {
      type: 'example',
      title: 'Example',
      text: 'Consult solving problems when this part of your work needs a decision or review.',
    },
