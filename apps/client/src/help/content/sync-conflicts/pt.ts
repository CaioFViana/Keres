...
const page: HelpPage = {
  ...
  summary: 'Escolha qual versão manter quando duas mudanças competem.',
  keywords: ['quando aparece um conflito', 'ajuda'],
  blocks: [
    { type: 'heading', level: 2, text: 'O que é' },
    {
      type: 'paragraph',
      text: 'Um conflito pede uma decisão campo a campo: manter o seu, manter o do servidor, aceitar uma exclusão ou adiar.',
    },
    { type: 'heading', level: 2, text: 'Para que serve' },
    {
      type: 'example',
      title: 'Exemplo',
      text: 'Consulte quando aparece um conflito quando essa parte do trabalho precisar de uma decisão ou revisão.',
    },
