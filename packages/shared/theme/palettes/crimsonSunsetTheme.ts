...
const darkColors: ThemeColors = {
  primary: '#FFB2B9',
  primaryVariant: '#FF8F9A',
  primaryContainer: '#872934',
  onPrimaryContainer: '#FFD9DC',
  secondary: '#FFB68C',
  secondaryVariant: '#E99C72',
  background: '#1D1214',
  surface: '#26191B',
  error: '#FFB4AB',
  onPrimary: '#650016',
