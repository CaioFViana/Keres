...
relationRoutes.post('/', zValidator('json', RelationCreateSchema), (c) => relationController.createRelation(c));
...
relationRoutes.put('/:id', zValidator('json', RelationUpdateSchema), (c) => relationController.updateRelation(c));
