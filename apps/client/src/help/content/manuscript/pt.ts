  ...
  blocks: [
    ...
    { type: 'path', segments: ['Menu da história', 'Elementos narrativos', 'Abrir cena', 'Escrever manuscrito'] },
    {
      ...
      items: [
        ...
        'Escreva no modo Escrever. A barra acima do texto aplica **negrito**, *itálico*, __sublinhado__ e títulos; o texto fica a salvo como rascunho local até você salvar.',
