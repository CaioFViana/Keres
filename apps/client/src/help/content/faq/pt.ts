...
const page: HelpPage = {
  ...
  summary: 'Encontre respostas curtas para dúvidas recorrentes.',
  keywords: ['perguntas frequentes', 'ajuda'],
  blocks: [
    { type: 'heading', level: 2, text: 'O que é' },
    {
      type: 'paragraph',
      text: 'Perguntas frequentes apontam o caminho para páginas completas quando uma resposta precisa de mais contexto.',
    },
    { type: 'heading', level: 2, text: 'Para que serve' },
    {
      type: 'example',
      title: 'Exemplo',
      text: 'Consulte perguntas frequentes quando essa parte do trabalho precisar de uma decisão ou revisão.',
    },
