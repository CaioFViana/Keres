...
import type { TagRemovalPayload } from '@keres/shared'

export class RemoveTagFromEntityUseCase {
  constructor(
  ...
  async execute(userId: string, data: TagRemovalPayload): Promise<void> {
    ...
    switch (targetType) {
      case 'Character':
        ...
        await this.tagRepository.removeTagFromCharacter(targetId, tagId)
        break
      case 'Location':
        ...
        await this.tagRepository.removeTagFromLocation(targetId, tagId)
        break
      case 'Chapter':
        ...
        await this.tagRepository.removeTagFromChapter(targetId, tagId)
        break
      case 'Scene':
        ...
        await this.tagRepository.removeTagFromScene(targetId, tagId)
        break
      default:
