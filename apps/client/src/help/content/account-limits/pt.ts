...
const page: HelpPage = {
  ...
  summary: 'Entenda os limites definidos pelo servidor.',
  keywords: ['limites da conta', 'ajuda'],
  blocks: [
    { type: 'heading', level: 2, text: 'O que é' },
    {
      type: 'paragraph',
      text: 'Um servidor pode limitar histórias, elementos, mídias e novos cadastros.',
    },
    { type: 'heading', level: 2, text: 'Para que serve' },
    {
      type: 'example',
      title: 'Exemplo',
      text: 'Consulte limites da conta quando essa parte do trabalho precisar de uma decisão ou revisão.',
    },
