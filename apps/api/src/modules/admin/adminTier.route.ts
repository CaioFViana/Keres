...
import { TierInUseError, TierNameAlreadyTakenError, TierNotFoundError, tierService } from '../../services/TierService';
...
export const adminTierRoutes = new Elysia()
  ...
  .delete('/:id', async ({ params, user, set }) => {
    ...
    params: t.Object({ id: t.String() }),
    detail: { summary: 'Soft-delete a tier (refused if still in use)', tags: ['Admin'], security: [{ bearerAuth: [] }] },
  });
